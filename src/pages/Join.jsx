					...
					<div className="relative overflow-hidden border-b border-[#C49A45]/20 bg-[radial-gradient(circle_at_top_right,rgba(197,160,89,0.18),transparent_50%),linear-gradient(120deg,#17120d_0%,#0f0f0f_55%,#1a1410_100%)] px-6 py-8 sm:px-10 sm:py-10">
						...
						<div className="relative z-10">
							...
							<h1 className="mt-4 max-w-3xl text-2xl font-semibold leading-tight text-white sm:text-4xl">
								Choose Your Society 22 Encounter
							</h1>
					...
					<div className="border-t border-[#C49A45]/35 bg-[#0a0a0a] px-6 py-7 sm:px-10 sm:py-8">
						...
						{forms.length === 0 && !error ? (
							<div className="rounded-lg border border-[#C49A45]/30 bg-[#0D0D0D] px-6 py-8 text-center">
								...
								<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
									{forms.map((form) => (
										<article
											key={form.slug}
											className="group relative flex h-full flex-col rounded-lg border border-[#C49A45]/40 bg-[#0D0D0D] p-6 text-left transition hover:border-[#C49A45] hover:bg-[#131313]"
										>
												...
												<div className="mt-auto pt-5">
													{form.google_form_url ? (
														<a
															...
															className="inline-flex w-full items-center justify-center rounded-full border border-[#E68A00] bg-[#E68A00] px-4 py-3 text-sm font-semibold text-white shadow-[0_10px_24px_rgba(230,138,0,0.18)] transition hover:bg-[#C49A45] hover:border-[#C49A45]"
														>
															Go to Google Form
														</a>
													) : (
														<Link
															to={`/forms/${form.slug}`}
															className="inline-flex w-full items-center justify-center rounded-full border border-[#C49A45] bg-[#C49A45] px-4 py-3 text-sm font-semibold text-black shadow-[0_10px_24px_rgba(196,154,69,0.18)] transition hover:bg-[#E3C37E]"
														>
															Apply Now
														</Link>
													)}
							...
							<div className="mt-8 flex justify-center">
								<button
									type="button"
									className="rounded-full bg-[#c29d53] px-6 py-3 font-semibold text-black transition-colors duration-200 hover:bg-[#a8843b]"
								>
									Go to Google Form
								</button>
							</div>
